...
namespace KarnaughMap
{
    public static class Utils
    {
        ...
        {
            if (group.Count == 0)
                throw new ArgumentException("El grupo debe contener al menos un término");

            // Tome el primer término y "marque" todas las variables que cambian de valor en el grupo
